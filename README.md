# Initial Project Setup for Flutter
...
/nPlease use latest dependencies below:
/nChange package name   : change_app_package_name: ^1.3.0
/nChange app name       : rename_app: ^1.6.1
/nChange icon launcher  : icons_launcher: ^3.0.0
